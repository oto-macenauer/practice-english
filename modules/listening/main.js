(async () => {
  ...
  function renderPicker() {
    ...
    if (!speechSupported) {
      ...
      warn.textContent =
        "Your browser does not support speech synthesis. Listening exercises may not work. Please try Chrome, Edge or Safari.";
  ...
  function startQuiz(selected) {
    ...
    sections.forEach((section) => {
      ...
      checkBtn.addEventListener("click", () => {
        ...
        App.saveScore("listening", unitId, section.id, sectionScore, items.length);
      });
