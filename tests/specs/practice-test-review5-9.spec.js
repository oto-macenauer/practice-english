...
test.describe('Practice Test — Review 5-9', () => {
  test.beforeEach(async ({ page }) => {
    await navigateToModule(page, '/modules/practice-tests/review5-9/index.html');
  });
  ...
  test('reading section with passage is displayed', async ({ page }) => {
