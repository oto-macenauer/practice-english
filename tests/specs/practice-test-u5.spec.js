...
test.describe('Practice Test — Unit 5', () => {
  test.beforeEach(async ({ page }) => {
    await navigateToModule(page, '/modules/practice-tests/unit5/index.html');
  });
  ...
  test('answering and checking a section disables the Check button and shows score', async ({ page }) => {
    ...
    // Answer all question types that might be present
